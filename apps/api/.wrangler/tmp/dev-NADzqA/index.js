...
// .wrangler/tmp/bundle-gyHoHC/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-gyHoHC/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// src/requests/spotify/api/authTokenExchange.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
var createBearerTokenHeader = /* @__PURE__ */ __name((clientId, clientSecret) => {
  const authorization = clientId + ":" + clientSecret;
  const authBuffer = Buffer2.from(authorization).toString("base64");
  return "Basic " + authBuffer;
}, "createBearerTokenHeader");

// src/requests/spotify/api/authTokenExchange.ts
var authTokenExhange = /* @__PURE__ */ __name(async (clientId, clientSecret, redirectUri, code) => {
...
// src/requests/spotify/api/currentlyPlaying.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// src/normalisers/currentlyPlaying.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var currentlyPlayingNormaliser = /* @__PURE__ */ __name((data) => {
  return {
    ...
    album: {
      ...
      artists: data.item?.album?.artists?.map((artist) => ({
...
}, "currentlyPlayingNormaliser");

// src/requests/spotify/utils/fetch.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var spotifyHeaders = /* @__PURE__ */ __name((accessToken) => {
  return {
    method: "GET",
    headers: {
...
// src/requests/spotify/utils/url.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var currentlyPlayingUrl = /* @__PURE__ */ __name(() => "https://api.spotify.com/v1/me/player/currently-playing", "currentlyPlayingUrl");

// src/requests/spotify/api/currentlyPlaying.ts
var getCurrentlyPlaying = /* @__PURE__ */ __name(async (accessToken) => {
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var getEnvKey = /* @__PURE__ */ __name((c, envKey) => c.env[envKey], "getEnvKey");
...
var loginUrl = /* @__PURE__ */ __name((client_id, redirect_uri, state, scopes2) => {
  return "https://accounts.spotify.com/authorize?" + import_qs.default.stringify({
    response_type: "code",
    client_id,
    scope: scopes2,
    redirect_uri,
...
var tokenExchangeErrorUrl = "/#" + import_qs.default.stringify({ error: "state_mismatch" });

// src/routes/callback.ts
var callbackRoute = new Hono2();
...
// src/routes/currentlyPlaying.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var currentlyPlayingRoute = new Hono2();
...
// src/routes/login.ts
var scopes = ["user-read-currently-playing"].join(" ");
var loginRoute = new Hono2();
