...
// .wrangler/tmp/bundle-cgXEzB/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-cgXEzB/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
callbackRoute.get("/callback", async (c) => {
  ...
  const cookieOptions2 = { secure: true };
  setCookie(c, "spotify_access_token", tokenJson.access_token, cookieOptions2);
  setCookie(c, "spotify_refresh_token", tokenJson.refresh_token, cookieOptions2);
...
// src/requests/spotify/api/spotifyUser.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var spotifyUserUrl = /* @__PURE__ */ __name(() => "https://api.spotify.com/v1/me", "spotifyUserUrl");
var spotifyUserPlaylistUrl = /* @__PURE__ */ __name((offset) => `https://api.spotify.com/v1/me/playlists?limit=50&offset=${offset}`, "spotifyUserPlaylistUrl");

// src/requests/spotify/api/spotifyUser.ts
var spotifyUser = /* @__PURE__ */ __name(async (accessToken) => {
...
// src/routes/user.ts
var currentUserRoute = new Hono2();
currentUserRoute.get("/current-user", async (c) => {
  const denied = /* @__PURE__ */ __name((error3) => c.json({ user: false, error: error3 }, 404), "denied");
...
// src/routes/user/playlists.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// src/requests/spotify/api/spotifyUser/playlists.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var spotifyUserPlaylists = /* @__PURE__ */ __name(async (accessToken, offset) => {
...
// src/routes/user/playlists.ts
var currentUserPlaylistsRoute = new Hono2();
var getOffsetsForRestOfPlaylists = /* @__PURE__ */ __name((total, limit = 50) => {
